...
<body>
<h2>AIram Chat</h2><div id="chat" style="height:300px;overflow:auto;border:1px solid #ccc;padding:5px"></div>
<input id="inp" style="width:80%"/><button onclick="s()">Wyślij</button>
<script>
async function s(){
